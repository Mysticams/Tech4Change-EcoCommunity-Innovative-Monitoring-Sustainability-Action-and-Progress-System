...
<head>
    ...
    <style>
        ...
        input:focus, textarea:focus {
            background-color: #E8F5E9; /* Light green when focused */
            border-color: #5C6BC0; /* Soft blue focus border */
            outline: none;
        }
        ...
        button:hover {
            background-color: #3E4A89; /* Darker blue on hover */
        ...
        .cta-button button:hover {
            background-color: #81D4FA; /* Medium blue on hover */
            transform: translateY(-2px);
        }
