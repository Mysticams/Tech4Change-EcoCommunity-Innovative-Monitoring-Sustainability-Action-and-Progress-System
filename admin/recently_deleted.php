...
<body>
                ...
                <?php foreach ($recentlyDeletedProjects as $project): ?>
                    <li class="project-item">
                        ...
                        <button class="restore-button"
                            onclick="restoreProject(<?php echo $project['id']; ?>)">Restore</button>
                    </li>
                <?php endforeach; ?>
            </ul>
        <?php else: ?>
    ...
    <a href="projects.php" class="back-button">Return to Projects</a>

    <script>
        // restore the project using AJAX
        function restoreProject(projectId) {
            $.ajax({
                type: "POST",
                url: "recently_deleted.php",
                data: {
