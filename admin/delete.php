...
<body>
    <script>
        // SweetAlert to show status message
        document.addEventListener('DOMContentLoaded', function() {
            <?php if ($message): ?>
                Swal.fire({
                    ...
                    willClose: () => {
                        // Redirect to the project list after closing the SweetAlert
                        window.location.href = 'list.php'; // Ensure the project list page excludes deleted projects
                    }
                });
            <?php endif; ?>
        });
