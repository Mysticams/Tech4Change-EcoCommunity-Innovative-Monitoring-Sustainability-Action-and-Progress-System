...
<body>
                ...
                <?php foreach ($projects as $proj): ?>
                    <li class="project-item">
                        <div>
                            ...
                            <div class="project-progress"><?php echo htmlspecialchars($proj['progress']); ?>%</div>
                        </div>
                        <div>
                            <a href="update.php?id=<?php echo $proj['id']; ?>" class="update-btn">Update</a>
                            <a href="delete.php?id=<?php echo $proj['id']; ?>" class="delete-btn" onclick="return confirmDelete(event)">Delete</a>
                        </div>
                    </li>
                <?php endforeach; ?>
            </ul>
    ...
    <!-- Return Button -->
    <button class="return-btn" onclick="window.location.href='userDashboard.php'">Return to Dashboard</button>

    <script>
        // SweetAlert2 popup when a project is deleted
